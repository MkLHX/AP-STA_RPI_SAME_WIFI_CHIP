...
## Usage
```bash
curl https://raw.githubusercontent.com/altinal/AP_STA_RPI_SAME_WIFI_CHIP/master/ap_sta_config.sh | sudo bash -s -- --ap ap_ssid ap_passphrases --client client_ssid client_passphrase --country FR
